...
class Swiper extends Component {
  ...
  onPanResponderMove = (event, gestureState) => {
    ...
    let evt = this.createAnimatedEvent()
    // doesn't seem like PanResponder events allow useNativeDriver: true
    // Ref: https://reactnative.dev/docs/animations#using-the-native-driver
    return Animated.event([null, { dx: evt.dx, dy: evt.dy }], {
